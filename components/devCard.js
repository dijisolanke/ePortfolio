        ...
        <div style={position} >
          <Accordion sx={{bgcolor: "#f1f1f1"}} expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
            ...
            <AccordionDetails>
              <Typography>
                ...
                This is so I could update content without having to re-deploy my site or change the code.<br/>
          ...
          <Accordion sx={{bgcolor: "#f1f1f1"}} expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
            ...
            >
              ...
              <u><a href="https://tester-axca15jry-dijisolanke.vercel.app/posts" target="_blank"> Click here to view site</a></u>
              </Typography>
            </AccordionSummary>
            <AccordionDetails>
              <Typography>
                The aim of this project was to give a short demonstration to perspective clients showcasing a potential build <br/>
                method for a site they wanted. This is why it doesn't have much functionality.<br/><br/>
          ...
          <Accordion sx={{bgcolor: "#f1f1f1"}} expanded={expanded === 'panel3'} onChange={handleChange('panel3')}>
            ...
            >
              ...
              <Typography sx={{ color: 'text.secondary' }}>
              <u><a href="https://sachadelabre.com/" target="_blank"> Click here to view site</a></u>
              </Typography>
            </AccordionSummary>
            <AccordionDetails>
              <Typography>
                ...
                My client wanted to be able to receive order requests via email so I used PHP to process form requests. <br/>
          ...
          <Accordion sx={{ bgcolor: "#f1f1f1"}} expanded={expanded === 'panel4'} onChange={handleChange('panel4')}>
            ...
            <AccordionDetails>
              <Typography>
                To view my Github  &nbsp;&nbsp;
              <u><a href="https://github.com/dijisolanke" target="_blank"> Click here</a></u> <br/><br/>

                <h4>More</h4>
                I worked on a government Project just before Christmas, the content of which have to remain classified. <br/>
                On that Project I was working with Drupal 9. Throughout that project, I learned a lot about Drupal and It's templating engine. <br/>
                I learned how to use Twig. A templating mark-up language. <br/><br/>

                I'm currently building my first full mobile application using Flutter. The learning curve is quite steep but I expect to <br/>
                be finished in a couple of months at which point I shall add a link to it here.<br/>
                I think flutter is a powerful framework and am looking forward to mastering it. Not gonna lie, it's quite exciting and I spend <br/>
                most morning's working on it.
                 <br/><br/>

                I've also spent some time working with WordPress' child Theming feature and had the pleasure of making very minor adjustments <br/>
                To a live website called <u><a href="https://www.websand.co.uk/consent-signup-page/" target="_blank"> Websands</a></u>
